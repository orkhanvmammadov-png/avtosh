...
export default async function FavoritesPage() {
  ...
  return (
    <div className="py-8" data-testid="favorites-page">
      <h1 className="text-2xl font-bold text-navy">{UI.favorites}</h1>
      {items.length === 0 ? (
        <div className="mt-10 rounded-card border border-line bg-white px-6 py-12 text-center" data-testid="favorites-empty">
