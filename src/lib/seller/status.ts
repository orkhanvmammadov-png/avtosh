...
export const STATUS_PRESENTATION: Record<string, StatusPresentation> = {
  ...
  PAYMENT_COMPLETED: { label: "Ödənilib", tone: "success", action: { kind: "none" } },
  PENDING_MODERATION: { label: "Yoxlanılır", tone: "warning", action: { kind: "wizard", label: "Ətraflı" } },
  CORRECTION_REQUIRED: { label: "Düzəliş tələb olunur", tone: "danger", action: { kind: "wizard", label: "Düzəliş et" } },
  REJECTED: { label: "Rədd edildi", tone: "danger", action: { kind: "wizard", label: "Redaktə et" } },
