...
const DEFAULT_STATUS: Record<ApiErrorCode, number> = {
  ...
  LISTING_CONTACT_UNAVAILABLE: 409,
  CONTACT_RATE_LIMITED: 429,
  PAYMENT_NOT_REQUIRED: 409,
  PAYMENT_CHECKOUT_UNAVAILABLE: 503,
  PROMOTION_NOT_AVAILABLE: 409,
  PROMOTION_PACKAGE_NOT_FOUND: 404,
  PROMOTION_PAYMENT_PENDING: 409,
  LISTING_LIFECYCLE_CONFLICT: 409,
};
