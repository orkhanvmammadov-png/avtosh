...
**Current phase: Phase 4.7 — Moderation & Listing Activation.**
...
resubmission). Payment-provider fulfillment, public search, and the
expiry/notification workers are not implemented yet. `CLAUDE.md` is the authoritative
